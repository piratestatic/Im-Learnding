...
public class HelloWorldGUI2 {
	...
	private static class ButtonHandler implements ActionListener {
     ...
     public static void main(String[] args) {
          ...
          //This is necessary to get the event from the button to the listener object
          //The listener object must register itself with the button as an event listener. 
